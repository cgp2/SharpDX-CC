...
namespace SharpDX.Games
{
    class WhirlingCubeGame : Game, IDisposable
    {
        ...
        public void Run()
        {
            ...
            cube1.WorldPosition = new Vector3(5f, 0f, 5f);
            cube1.Update();

            cube2 = new CubeComponent(device);
            cube2.WorldPosition = new Vector3(-5f, 0f, -5f);
            cube2.Update();

            cube3 = new CubeComponent(device);
            cube3.WorldPosition = new Vector3(-5f, 5f, 5f);
            cube3.Update();

            cube4 = new CubeComponent(device);
            cube4.WorldPosition = new Vector3(5f, -5f, -5f);
            cube4.Update();
