...
namespace texturing
{
    public abstract class Game 
    {
        ...
        protected Direct3D11.RenderTargetView renderTargetView;
        ...
        {
            new Direct3D11.InputElement("POSITION", 0, Format.R32G32B32_Float, 0, 0, Direct3D11.InputClassification.PerVertexData, 0),
            new Direct3D11.InputElement("COLOR", 0, Format.R32G32B32A32_Float, 12, 0, Direct3D11.InputClassification.PerVertexData, 0)
        };
        ...
        public Game()
        {
            ...
            Camera = new CameraComponent((float)renderForm.Width / renderForm.Height, new Vector3(0, 2, -3), new Vector3(0, 0, 0));
        ...
        protected void InitializeDeviceResources()
        {
            ...
            Direct3D11.Device.CreateWithSwapChain(Direct3D.DriverType.Hardware, Direct3D11.DeviceCreationFlags.None, swapChainDescriptor, out device, out swapChain);
            ...
            {
                renderTargetView = new Direct3D11.RenderTargetView(device, backBuffer);
            }
        ...
        { 
            ...
            inputLayout = new Direct3D11.InputLayout(device, inputSignature, inputElements);
